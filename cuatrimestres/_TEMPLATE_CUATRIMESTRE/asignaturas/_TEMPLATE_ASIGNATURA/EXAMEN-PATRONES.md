# PATRONES DE EXAMEN · <ASIGNATURA>

> El *fight tape*: qué cae y cómo. Lo genera el coach en el `onboard` (`methodology/02` Step 4)
> minando los exámenes de años anteriores. Cuantos más años, mejor señal.
...
- <tipo A> + <tipo B> + <tipo C> ≈ **<%> de la nota**.

## Patrones de redacción / trampas del profesor
- <qué se repite casi idéntico cada año>
- <trampas frecuentes, enunciados engañosos, unidades, formato esperado de respuesta>
